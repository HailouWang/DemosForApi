 ...
 *
 * 使用自定义片段事务演示“卡片翻转”动画
 * （{@link * android.app.FragmentTransaction＃setCustomAnimations（int，int）}）。* * <p>
 * 此示例显示一个“info”动作栏按钮，显示“卡”的背面，旋转 *前面的卡出来和后面的卡片。
 * 反向动画播放时用户 *按系统后退按钮或“照片”操作栏按钮。
 *
 * 实现方式：
 * getFragmentManager()
 * .beginTransaction()
 * .setCustomAnimations（R.animator.xxx,R.animator.xxxx）
 *
 */
