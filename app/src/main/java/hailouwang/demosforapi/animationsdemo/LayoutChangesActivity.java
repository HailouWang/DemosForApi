 ...
 *
 *
 * 此示例演示如何使用系统提供的自动布局转换。
 * 布局 *过渡是在视图添加到，从中移除或更改视图时发生的动画 *一个{@link ViewGroup}。* * <p>
 * 在此示例中，用户可以向垂直方向添加行并从中删除行 * {@link android.widget.LinearLayout}。
 *
 * 实现：
 * LinearLayout在xml配置中，配置了android:animateLayoutChanges="true"
 *
 *
 *
 */
