package hailouwang.demosforapi.canvas;
...
import hailouwang.demosforapi.app.lifecycle.util.StatusTracker;
...
public class BaseCanvasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d(Utils.HLWANG_TAG,"BaseCanvasActivity..onClickListener :"
    ...
    class CustomView extends View {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            Log.d(Utils.HLWANG_TAG,"BaseCanvasActivity onMeasure widthSize :"+widthSize
            +",widthMode :"+widthMode
        ...
        protected void onSizeChanged(int w, int h, int oldw, int oldh) {
            ...
            Log.d(Utils.HLWANG_TAG,"BaseCanvasActivity onSizeChanged w :"+w
                    +",h :"+h
                    +",oldW:"+oldw
                    +",oldH:"+oldh);
            width = w;
