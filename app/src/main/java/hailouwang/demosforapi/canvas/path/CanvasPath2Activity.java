...
//        RectF rectF = new RectF(0,0,300,-300);
        ...
        Path path3 = new Path();
        Log.d(Utils.HLWANG_TAG,"CanvasPath2Activity onSelfDraw path3 before isEmpty :"+path3.isEmpty());
        path3.moveTo(100,100);
        Log.d(Utils.HLWANG_TAG,"CanvasPath2Activity onSelfDraw path3 after isEmpty :"+path3.isEmpty());

        path3.lineTo(200,100);
        path3.lineTo(200,20);
        path3.lineTo(100,20);
        boolean isRect = path3.isRect(rectF3);
        Log.d(Utils.HLWANG_TAG,"CanvasPath2Activity onSelfDraw path3 isRect :"+isRect+",RectF :"+rectF3);
