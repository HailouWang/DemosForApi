...
public class CanvasPathMeasureActivity extends BaseCanvasActivity {
    ...
    protected void onSelfDraw(Canvas canvas, int width, int height) {
        ...
        Log.d(Utils.HLWANG_TAG, "CanvasPathMeasureActivity onSelfDraw value1:" + pathMeasure1.getLength()
...
//        canvas.translate(tempWidth*2,0);
        ...
        Log.d(Utils.HLWANG_TAG,"CanvasPathMeasureActivity ....length :"+pathMeasure4.getLength());
        boolean isNextContor1 = pathMeasure4.nextContour();
        Log.d(Utils.HLWANG_TAG,"CanvasPathMeasureActivity ....isNextContor1 :"+isNextContor1
        ...
        Log.d(Utils.HLWANG_TAG,"CanvasPathMeasureActivity onSelfDraw。。length:"+length);
        ...
        for(int i=0;i<length;i+=50){
            ...
            Log.d(Utils.HLWANG_TAG,"CanvasPathMeasureActivity onSelfDraw pos1:"+pos[0]
            +",pos2:"+pos[1]
            +",tan[1]:"+tan[0]
            +",tan[2]:"+tan[1]
            +",arcDegree:"+arcDegree
        ...
        for(int i=0;i<length;i+=50){
            ...
            Log.d(Utils.HLWANG_TAG,"CanvasPathMeasureActivity onSelfDraw posTan:"+posTan
                    +",getMatrix:"+getMatrix
                    +",tan[1]:"+tan[0]
                    +",tan[2]:"+tan[1]
                    +",pos[1]:"+pos[0]
