 ...
 */
package hailouwang.demosforapi.picasso;
...
import static hailouwang.demosforapi.picasso.SampleContactsActivity.ContactsQuery;
...
class SampleContactsAdapter extends CursorAdapter {
  ...
  @Override public void bindView(View view, Context context, Cursor cursor) {
    ...
    Picasso.with(mContext)
        .load(contactUri)
        .placeholder(R.drawable.contact_picture_placeholder)//加载中的替换图片
        .tag(context)
        .into(holder.icon);
  }
